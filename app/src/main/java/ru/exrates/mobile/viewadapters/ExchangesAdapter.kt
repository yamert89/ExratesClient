...
class ExchangesAdapter(private val pairsByExchanges: List<CurrencyPair>, private val pairName : String, var interval: String = "1h"): RecyclerView.Adapter<ExchangesAdapter.ExchangeViewHolder>() {
