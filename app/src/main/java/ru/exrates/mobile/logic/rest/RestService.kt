...
interface RestService {
    ...
    @GET("rest/lists")
    fun lists(): Call<MutableMap<Int, ExchangeNamesObject>>
    ...
    fun addOnePair(@Query("c1") c1: String, @Query("c2") c2: String, @Query("exId") exId: Int, @Query("currentInterval") interval: String): Call<CurrencyPair>
